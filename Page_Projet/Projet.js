    ...
    el.innerHTML = `
        ...
        return "";
            ...
            <div class="exp-info">
                ...
                <p class="exp-desc">${typeof t === "function" && p.descKey ? t(p.descKey) : p.description || ""}</p>
                <div class="exp-actions">
                    ${p.cahier ? `<a href="${p.cahier}" class="btn btn-primary" target="_blank">${typeof t === "function" ? t("btn_cahier") : "📄 Cahier des charges"}</a>` : ""}
                    ${p.github ? `<a href="${p.github}" class="btn btn-ghost" target="_blank">
                        ...
                        GitHub</a>` : ""}
                    ${p.itch ? `<a href="${p.itch}" class="btn btn-ghost btn-itch" target="_blank">${typeof t === "function" ? t("btn_test_itch") : "🎮 Tester sur itch.io"}</a>` : ""}
                    ${p.youtube ? `<a href="${p.youtube}" class="btn btn-ghost btn-yt" target="_blank">
                        ...
                        ${typeof t === "function" ? t("btn_gameplay") : "Voir gameplay complet"}</a>` : ""}
                </div>
            </div>
        </div>`;
...
/* ── LANG CHANGE — rebuild cards on language switch ── */
